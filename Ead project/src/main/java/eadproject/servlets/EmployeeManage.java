...
public class EmployeeManage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			String sqlQuery = "select * from employees where eID='"+req.getParameter("id").toString()+"'";
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		//DB operation
			try {
				...
				String sqlQuery = "update employees set eNIC='"+ nic +"' , ename='"+name+"' ,edepartment='"+ department +
						 "', edesignation='"+designation+"' where eID="+id;
				Statement stmt = con.createStatement();
	...
	protected void doDelete(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			String sqlQuerys = "delete from employees where eID='"+id+"';";
